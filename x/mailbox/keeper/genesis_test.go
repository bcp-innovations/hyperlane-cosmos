...
func TestInitGenesis(t *testing.T) {
	...
	data := &mailbox.GenesisState{
		Counters: []mailbox.Counter{
			{
				Address: fixture.addrs[0].String(),
				Count:   5,
			},
		},
		Params: mailbox.DefaultParams(),
	}
	...
	require.Equal(t, mailbox.DefaultParams(), params)
...
func TestExportGenesis(t *testing.T) {
	...
	_, err := fixture.msgServer.IncrementCounter(fixture.ctx, &mailbox.MsgIncrementCounter{
	...
	require.Equal(t, mailbox.DefaultParams(), out.Params)
