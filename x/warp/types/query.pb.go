...
type QueryTokensResponse struct {
	...
	Tokens []QueryTokenResponse `protobuf:"bytes,1,rep,name=tokens,proto3" json:"tokens"`
}
...
func (m *QueryTokensResponse) GetTokens() []QueryTokenResponse {
	if m != nil {
		return m.Tokens
	}
	return nil
...
func (m *QueryTokenResponse) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *QueryTokenResponse) GetTokenType() HypTokenType {
	if m != nil {
		return m.TokenType
	}
...
func (m *QueryTokenResponse) GetOriginMailbox() string {
	if m != nil {
...
func (m *QueryTokenResponse) GetOriginDenom() string {
	if m != nil {
...
func (m *QueryTokenResponse) GetIsmId() string {
	if m != nil {
		return m.IsmId
	}
	return ""
...
type QueryBridgedSupplyResponse struct {
	BridgedSupply string `protobuf:"bytes,1,opt,name=bridged_supply,json=bridgedSupply,proto3" json:"bridged_supply,omitempty"`
}
...
func (m *QueryBridgedSupplyResponse) GetBridgedSupply() string {
	if m != nil {
...
func (m *QueryQuoteGasPaymentRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*QueryQuoteGasPaymentRequest)(nil), "hyperlane.warp.v1.QueryQuoteGasPaymentRequest")
	proto.RegisterType((*QueryQuoteGasPaymentResponse)(nil), "hyperlane.warp.v1.QueryQuoteGasPaymentResponse")
...
var fileDescriptor_3514340e89a94dcf = []byte{
	...
	,
}
...
func (c *queryClient) QuoteGasPayment(ctx context.Context, in *QueryQuoteGasPaymentRequest, opts ...grpc.CallOption) (*QueryQuoteGasPaymentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hyperlane.warp.v1.Query/QuoteGasPayment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_QuoteGasPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hyperlane.warp.v1.Query/QuoteGasPayment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryBridgedSupplyResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BridgedSupply) > 0 {
		i -= len(m.BridgedSupply)
		copy(dAtA[i:], m.BridgedSupply)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.BridgedSupply)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QueryTokensResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Tokens = append(m.Tokens, QueryTokenResponse{})
...
func (m *QueryBridgedSupplyResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.BridgedSupply = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
