...
func (*MsgIncrementCounter) Descriptor() ([]byte, []int) {
	return fileDescriptor_c5685af8c638fcfd, []int{0}
}
...
func (*MsgIncrementCounterResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c5685af8c638fcfd, []int{1}
}
...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_c5685af8c638fcfd, []int{2}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c5685af8c638fcfd, []int{3}
}
...
func init() {
	proto.RegisterType((*MsgIncrementCounter)(nil), "KYVENetwork.mailbox.v1.MsgIncrementCounter")
	proto.RegisterType((*MsgIncrementCounterResponse)(nil), "KYVENetwork.mailbox.v1.MsgIncrementCounterResponse")
	proto.RegisterType((*MsgUpdateParams)(nil), "KYVENetwork.mailbox.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "KYVENetwork.mailbox.v1.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("KYVENetwork/mailbox/v1/tx.proto", fileDescriptor_c5685af8c638fcfd) }

var fileDescriptor_c5685af8c638fcfd = []byte{
	// 421 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xf7, 0x8e, 0x0c, 0x73,
	0xf5, 0x4b, 0x2d, 0x29, 0xcf, 0x2f, 0xca, 0xd6, 0xcf, 0x4d, 0xcc, 0xcc, 0x49, 0xca, 0xaf, 0xd0,
	...
	,
}
...
func (c *msgClient) IncrementCounter(ctx context.Context, in *MsgIncrementCounter, opts ...grpc.CallOption) (*MsgIncrementCounterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/KYVENetwork.mailbox.v1.Msg/IncrementCounter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/KYVENetwork.mailbox.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_IncrementCounter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/KYVENetwork.mailbox.v1.Msg/IncrementCounter",
	}
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/KYVENetwork.mailbox.v1.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "KYVENetwork.mailbox.v1.Msg",
	...
	Metadata: "KYVENetwork/mailbox/v1/tx.proto",
}
