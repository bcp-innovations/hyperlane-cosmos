...
const (
	Msg_IncrementCounter_FullMethodName = "/KYVENetwork.mailbox.v1.Msg/IncrementCounter"
	Msg_UpdateParams_FullMethodName     = "/KYVENetwork.mailbox.v1.Msg/UpdateParams"
)
