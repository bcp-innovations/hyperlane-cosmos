...
const (
	Query_Counter_FullMethodName  = "/KYVENetwork.mailbox.v1.Query/Counter"
	Query_Counters_FullMethodName = "/KYVENetwork.mailbox.v1.Query/Counters"
	Query_Params_FullMethodName   = "/KYVENetwork.mailbox.v1.Query/Params"
)
